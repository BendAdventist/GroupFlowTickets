        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinIntervalInSeconds = table.Column<uint>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxReservations = table.Column<uint>(type: "INTEGER", nullable: false),
                    MaxWalkIns = table.Column<uint>(type: "INTEGER", nullable: false),
                    Overflow = table.Column<uint>(type: "INTEGER", nullable: false),
                    MinReleaseTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    HasBeenReleased = table.Column<bool>(type: "INTEGER", nullable: false),
                    PrecedingGroupId = table.Column<Guid>(type: "TEXT", nullable: true),
                    EventId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfTickets = table.Column<uint>(type: "INTEGER", nullable: false),
                    GroupId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ReservedByUserId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
